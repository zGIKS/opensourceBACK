...
@Table(name = "fulfillments", 
       indexes = {@Index(name = "idx_fulfillments_order_id", columnList = "order_id"),
                 @Index(name = "idx_fulfillments_manufacturer_id", columnList = "manufacturer_id")})
public class Fulfillment extends AuditableAbstractAggregateRoot<Fulfillment> {
    ...
    @Temporal(TemporalType.TIMESTAMP)
    private Date shippedDate;    @ManyToOne
